<div class="max-w-7xl mx-auto px-6 mt-6 relative group">
    ...
    <div
        class="pointer-events-none absolute left-6 top-0 bottom-0
                w-16 z-10
                bg-gradient-to-r from-white via-white/80 to-transparent">
    </div>

    <div
        class="pointer-events-none absolute right-6 top-0 bottom-0
                w-16 z-10
                bg-gradient-to-l from-white via-white/80 to-transparent">
    </div>

    <div class="swiper adsSwiper !pb-8">
            ...
            @php
                ...
                $ads = [
                    ...
                    [
                        ...
                        'icon' =>
                            '<svg class="w-24 h-24 text-white/20 -rotate-12" fill="currentColor" viewBox="0 0 24 24"><path d="M17 1.01L7 1c-1.1 0-2 .9-2 2v18c0 1.1.9 2 2 2h10c1.1 0 2-.9 2-2V3c0-1.1-.9-1.99-2-1.99zM17 19H7V5h10v14z"/></svg>', // Icon HP
                    ],
                    [
                    ...
                    [
                        ...
                        'icon' =>
                            '<svg class="w-24 h-24 text-white/20 -rotate-6" fill="currentColor" viewBox="0 0 24 24"><path d="M12 1L3 5v6c0 5.55 3.84 10.74 9 12 5.16-1.26 9-6.45 9-12V5l-9-4zm-2 16l-4-4 1.41-1.41L10 14.17l6.59-6.59L18 9l-8 8z"/></svg>', // Icon Shield
                    ],
                ];
            @endphp
                ...
                <div class="swiper-slide p-1">
                    <div
                        ...
                        <div class="relative z-10 max-w-[70%]">
                            ...
                            <button
                                class="mt-4 px-4 py-2 bg-white text-blue-900 text-xs font-bold rounded-full shadow-md hover:bg-gray-100 hover:scale-105 transition-transform duration-200">
                                {{ $ad['cta'] }} &rarr;
                            </button>
                        </div>
        ...
        <div
            class="swiper-button-next !w-8 !h-8 !bg-white/90 !rounded-full !shadow-md !text-blue-600 after:!text-xs hover:!bg-white hidden md:flex mr-2">
        </div>
        <div
            class="swiper-button-prev !w-8 !h-8 !bg-white/90 !rounded-full !shadow-md !text-blue-600 after:!text-xs hover:!bg-white hidden md:flex ml-2">
        </div>
    </div>
