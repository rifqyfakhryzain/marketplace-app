...
<div class="max-w-7xl mx-auto px-4 py-6">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div class="lg:col-span-8">
            ...
            >
                ...
                <div class="relative rounded">
                    ...
                    <div class="px-12 py-4">
                        <img
                            :src="images[active]"
                            class="w-full aspect-[4/3] object-cover rounded bg-gray-100"
                            alt="Foto Produk"
                        >
                    </div>
                ...
                <div class="flex gap-2 overflow-x-auto pb-1 scrollbar-hide">
                    <template x-for="(img, index) in images" :key="index">
                        <button
                            ...
                            :class="active === index ? 'ring-2 ring-blue-600' : ''"
                        >
                            <img
                                :src="img"
            ...
            <div
                x-data="{ open: false }"
                class="border rounded-lg bg-white p-4 relative"
            >
        ...
        <div class="lg:col-span-4 space-y-4">
            ...
            <div class="border rounded-lg bg-white p-4 space-y-4">
                ...
                <a
                    href="/user/{{ $product['user']['id'] }}/products"
            ...
            <div class="border rounded-lg bg-white p-2">
                ...
                <div
                    id="map"
                    class="relative w-full aspect-[4/3] rounded overflow-hidden bg-gray-100"
                >
                    {{-- DUMMY MAP GRID --}}
                    <div class="absolute inset-0 bg-[radial-gradient(circle_at_center,#e5e7eb_1px,transparent_1px)] bg-[size:16px_16px]"></div>
