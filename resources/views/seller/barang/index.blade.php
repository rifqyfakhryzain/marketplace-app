            ...
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-8">
                ...
                <div class="lg:col-span-9 space-y-6">
                    ...
                    <div class="bg-white rounded-xl p-4 shadow-sm border border-gray-100 flex flex-col sm:flex-row gap-4">
                        ...
                        <div class="sm:w-48">
                            <select
                                class="w-full border border-gray-300 rounded-lg text-sm py-2 px-3 focus:ring-blue-600 focus:border-blue-600">
                                        ...
                                        <tr>
                                            <td class="px-3 py-3 flex items-center gap-3">
                                                @if ($barang->images->first())
                                                    <img src="{{ asset('storage/' . $barang->images->first()->image_path) }}"
                                            ...
                                            <td class="px-6 py-4 text-right">
                                                <div class="flex items-center justify-end gap-2">
                                                    ...
                                                    <a href="{{ route('seller.products.show', $barang->id) }}"
                                                        class="p-1.5 text-gray-500 hover:text-blue-600 hover:bg-blue-50 rounded-md transition"
                                                        title="View Details">
                                                    ...
                                                    <a href="{{ route('seller.products.edit', $barang->id) }}"
                                                        class="p-1.5 text-gray-500 hover:text-amber-600 hover:bg-amber-50 rounded-md transition"
                                                        title="Edit">
                                                        <svg class="w-5 h-5" fill="none" stroke="currentColor"
                                                            viewBox="0 0 24 24">
                                                            <path stroke-linecap="round" stroke-linejoin="round"
                                                    ...
                                                    <form action="{{ route('seller.products.destroy', $barang->id) }}"
                                                        ...
                                                        @method('DELETE')
                                                        <button type="submit"
                                                            class="p-1.5 text-gray-500 hover:text-red-600 hover:bg-red-50 rounded-md transition"
                                                            title="Delete">
                                                            <svg class="w-5 h-5" fill="none" stroke="currentColor"
                                                                viewBox="0 0 24 24">
                                                                <path stroke-linecap="round" stroke-linejoin="round"
                                        ...
                                        <tr>
                                            <td colspan="5" class="px-6 py-12 text-center">
                                                <div class="flex flex-col items-center justify-center">
                                                    ...
                                                    <p class="text-gray-500 max-w-sm mt-1 mb-6">You haven't added any
                                                        products yet. Start selling by adding your first product.</p>
                                                    <a href="{{ route('seller.products.create') }}"
                                                        class="px-4 py-2 bg-indigo-600 text-white rounded-lg hover:bg-blue-600 transition">
                                                        Add First Product
                                                    </a>
                                                </div>
                                            </td>
