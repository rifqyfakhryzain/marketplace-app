    ...
    <div class="max-w-7xl mx-auto p-6">
        ...
        <div class="grid grid-cols-12 gap-6">
            ...
            <div class="col-span-12 md:col-span-9 space-y-6">
                ...
                <div class="bg-white rounded-lg shadow-sm p-6 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                    <div>
                    ...
                    <div class="flex gap-3">
                        ...
                        <form action="{{ route('seller.products.destroy', $barang->id) }}" method="POST" onsubmit="return confirm('Yakin ingin menghapus produk ini?');">
                            @csrf
                            @method('DELETE')
                            <button type="submit" class="inline-flex items-center px-4 py-2 bg-white text-red-600 border border-red-200 rounded-md font-medium hover:bg-red-50 transition">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div class="bg-white p-4 rounded-lg shadow-sm border-l-4 border-blue-500">
                        ...
                        <p class="text-2xl font-bold text-gray-800">0 <span class="text-sm font-normal text-gray-400">unit</span></p> {{-- Ganti dengan data real jika ada --}}
                    </div>
...
<div class="mb-6">
    ...
    @endif
                        ...
                        <p class="font-medium">{{ $barang->kategori->nama_kategori }}</p>
                            ...
                            <div>
                                ...
                                <div class="flex items-center gap-2">
                                    ...
                                    @if($barang->stok < 5)
                                        <span class="text-xs text-red-600 font-medium bg-red-50 px-2 py-1 rounded">Stok Menipis</span>
                                    @endif
                                </div>
                            </div>
                ...
                <div class="flex justify-start">
                    <a href="{{ route('seller.products') }}" class="text-gray-500 hover:text-gray-700 font-medium flex items-center gap-1 text-sm">
