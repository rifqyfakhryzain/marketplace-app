                ...
                <div x-data="{
                    ...
                    <div class="relative rounded">
                        ...
                        <div class="px-12 py-4">
                            <img :src="images[active]" class="w-full aspect-[4/3] object-cover rounded bg-gray-100"
                                alt="Foto Produk">
                        </div>
            ...
            <div class="lg:col-span-4 space-y-4">
                ...
                <div class="border rounded-lg bg-white p-4 space-y-4">
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <div class="flex-1">
                            <a href="/user/{{ $product['user']['id'] }}" class="font-semibold hover:underline">
                                {{ $product['user']['name'] }}
                            </a>
                    ...
                    <a href="/user/{{ $product['user']['id'] }}/products"
